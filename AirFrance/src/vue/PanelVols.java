...
public class PanelVols extends PanelPrincipal implements ActionListener {
    ...
    private JTextField txtClasseVol = new JTextField();
    ...
    public PanelVols() {
        ...
        this.panelForm.add(this.txtClasseVol);
        ...
        this.tableVols.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
              ...
              ///  if (numLigne >= 0 && numLigne < unTableau.getRowCount()) {
                     idVol = Integer.parseInt(tableVols.getValueAt(numLigne, 0).toString());
                     int reponse = JOptionPane.showConfirmDialog(null, "Voulez-vous supprimer ce vol ? ",
                             "Suppression vol", JOptionPane.YES_NO_OPTION);
                     if (reponse == 0) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == this.btAnnuler) {
            ...
            String classeVol = this.txtClasseVol.getText();
